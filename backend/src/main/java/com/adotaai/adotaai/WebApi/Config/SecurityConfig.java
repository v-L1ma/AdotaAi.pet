    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/lookups/especies").permitAll()
                ...
                .requestMatchers(HttpMethod.POST, "/especies/**").hasRole("ADMINISTRADOR")
                .requestMatchers(HttpMethod.PUT, "/especies/**").hasRole("ADMINISTRADOR")
                .requestMatchers(HttpMethod.DELETE, "/especies/**").hasRole("ADMINISTRADOR")
                .requestMatchers(HttpMethod.POST, "/racas/**").hasRole("ADMINISTRADOR")
                .requestMatchers(HttpMethod.PUT, "/racas/**").hasRole("ADMINISTRADOR")
                .requestMatchers(HttpMethod.DELETE, "/racas/**").hasRole("ADMINISTRADOR")
